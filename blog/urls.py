...
urlpatterns = [
    ...
    path('comments', CommentView.as_view(), name='comment-specific'),
    ...
    path('posts/<int:post_id>/reactions/<str:reaction_type>', ReactionView.as_view(), name='reaction-interact'),
    path('posts/<int:post_id>/reactions', ReactionView.as_view(), name='reaction-count'),
]
